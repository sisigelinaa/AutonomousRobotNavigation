...
def generate_launch_description():
    ...
    params_file_path = os.path.join(pkg_share, 'config', 'radar_nav2_params.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='slam_toolbox',
            output='screen',
            parameters=[params_file_path, {'mode': 'mapping'}]
        ),
        ...
        Node(
            ...
            parameters=[{
                'use_sim_time': True,
                'autostart': True,
                'node_names': ['slam_toolbox'] # This tells it to "wake up" slam_toolbox
            }]
        ),
        # 3. Nav2 Navigation (Planner, Controller, Recoveries)
